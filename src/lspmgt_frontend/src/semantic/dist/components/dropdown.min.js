          ...
          (m = {
                      ...
                      ? (!v && !f) || s
                        ? s &&
                          (e.shiftKey
                            ...
                            : (m.verbose('Selecting previous label'), n.removeClass(g.active)),
                          l && !r
                            ? i.addClass(g.active)
                            : i
                                .prev(w.siblingLabel)
                    ...
                    if (
                      ((t == p.enter || f) &&
                        (t == p.enter && d && u && !h.allowCategorySelection
                          ? (m.verbose('Pressed enter on unselectable category, opening sub menu'),
                            (t = p.rightArrow))
                          : v &&
                            (m.verbose('Selecting item from keyboard shortcut', o),
                            m.event.item.click.call(o, e),
                    ...
                    R.each(function() {
                      ...
                      if (null !== n && n !== J)
                        if (o)
                          ...
                          if (
                            (m.verbose('Ambiguous dropdown value using strict type check', e, i),
                            n === i || t === i)
                          )
                            return (s = e), !0;
                        ...
                        ? (h.apiSettings && h.saveRemoteData && m.save.remoteData(t, n),
                          h.useLabels
                            ...
                            : (m.add.value(n, t, e),
                              ...
                              m.set.activeItem(e)))
                        : i ||
                          (m.debug('Selected active value, removing label'), m.remove.selected(n))
                      : (h.apiSettings && h.saveRemoteData && m.save.remoteData(t, n),
                        m.set.text(t),
                        m.set.value(n, t, e),
            ...
            add: {
              ...
              variables: function(e, t) {
                ...
                return (
                  ...
                  o &&
                    ((n = m.get.selectionCount()), (e = e.replace('{maxCount}', h.maxSelections))),
              ...
              value: function(e, t, n) {
                ...
                m.has.value(e)
                  ...
                  : '' !== e
                    ? (X.isArray(a) ? ((i = a.concat([e])), (i = m.get.uniqueArray(i))) : (i = [e]),
                      m.has.selectInput()
                        ? m.can.extendSelect() &&
            ...
            is: {
              ...
              alreadySetup: function() {
                return (
                  S.is('select') && S.parent(w.dropdown).data(C) !== J && 0 === S.prev().length
                );
              },
            ...
            can: {
              activate: function(e) {
                return (
                  !!h.useLabels ||
                  (!m.has.maxSelections() || !(!m.has.maxSelections() || !e.hasClass(g.active)))
                );
              },
              openDownward: function(e) {
                ...
                return (
                  ...
                  (t = {
                    ...
                    ? (m.verbose('Dropdown can fit in context downward', t), (a = !0))
                    : t.below || t.above
                      ? (m.verbose('Dropdown cannot fit below, opening upward', t), (a = !1))
