          ...
          read: {
            ...
            settings: function() {
              !1 !== r.total &&
                ...
                !1 !== r.percent &&
                  (s.debug('Current percent set in settings', r.percent), s.set.percent(r.percent));
            },
          },
          bind: {
            ...
            labelInterval: function() {
              clearInterval(s.interval),
                ...
                (s.interval = setInterval(function() {
                  E.contains(P.documentElement, v) || (clearInterval(s.interval), (f = !1)),
                    s.set.labels();
                }, r.framerate));
            },
            labels: function() {
            ...
            barLabel: function(e) {
              e !== T
                ...
                : 'ratio' == r.label && s.total
                  ? (s.verbose('Adding ratio to bar label'), d.text(s.get.text(r.text.ratio)))
                  : 'percent' == r.label &&
