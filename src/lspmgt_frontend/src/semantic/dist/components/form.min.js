          ...
          (h = {
            ...
            bindEvents: function() {
              h.verbose('Attaching form events'),
                ...
                d.keyboardShortcuts && o.on('keydown' + m, f.field, h.event.field.keydown),
                n.each(function() {
                  var e = T(this),
                    t = e.prop('type'),
            ...
            validate: {
              ...
              field: function(n, e, t) {
                (t = t === O || t),
                  'string' == typeof n && (h.verbose('Validating field', n), (n = u[(e = n)]));
                ...
                return (
                  ...
                  o
                    ...
                    : (t && ((b = b.concat(l)), h.add.prompt(r, l), d.onInvalid.call(i, l)), !1)
                );
              },
              rule: function(e, t) {
