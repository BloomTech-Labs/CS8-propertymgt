!(function(D, e, T, N) {
  ...
  (e =
      ...
      return (
        h.each(function() {
          var a,
            ...
            s,
            r = D.isPlainObject(p)
              ? D.extend(!0, {}, D.fn.dimmer.settings, p)
              : D.extend({}, D.fn.dimmer.settings),
            n = r.selector,
            e = r.namespace,
            t = r.className,
            m = r.error,
            ...
            d = 'module-' + e,
            c = h.selector || '',
            l = 'ontouchstart' in T.documentElement ? 'touchstart' : 'click',
            u = D(this),
            f = this,
            g = u.data(d);
          (s = {
            ...
            event: {
              click: function(e) {
                s.verbose('Determining if event occured on dimmer', e),
                  (0 === a.find(e.target).length || D(e.target).is(n.content)) &&
            ...
            animate: {
              show: function(e) {
                (e = D.isFunction(e) ? e : function() {}),
                  r.useCSS && D.fn.transition !== N && a.transition('is supported')
            ...
            setting: function(e, i) {
              if ((s.debug('Changing setting', e, i), D.isPlainObject(e))) D.extend(!0, r, e);
              else {
                if (i === N) return r[e];
                D.isPlainObject(r[e]) ? D.extend(!0, r[e], i) : (r[e] = i);
              }
            },
            internal: function(e, i) {
              if (D.isPlainObject(e)) D.extend(!0, s, e);
              else {
                if (i === N) return s[e];
                s[e] = i;
              }
                ...
                'string' == typeof t &&
                  ...
                  D.each(t, function(e, i) {
                    ...
                    if (D.isPlainObject(r[n]) && e != o) r = r[n];
                      ...
                      if (!D.isPlainObject(r[i]) || e == o)
                        return r[i] !== N ? (a = r[i]) : s.error(m.method, t), !1;
                      r = r[i];
                    }
                  })),
                D.isFunction(a) ? (n = a.apply(i, e)) : a !== N && (n = a),
                D.isArray(v) ? v.push(n) : v !== N ? (v = [v, n]) : n !== N && (v = n),
                a
              );
            },
          }).preinitialize(),
    ...
    (D.fn.dimmer.settings = {
      ...
      template: {
        dimmer: function() {
          return D('<div />').attr('class', 'ui dimmer');
        },
      },
    });
