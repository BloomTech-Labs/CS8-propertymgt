              ...
              event: {
                ...
                keydown: function(e) {
                  var t = e.which,
                    ...
                    i = 32;
                  t == 27
                    ? (s.verbose('Escape key pressed blurring field'), d.blur(), (g = !0))
                    : e.ctrlKey || (t != i && t != n)
                      ? (g = !1)
          ...
          v.each(function() {
            ...
            (s = {
              ...
              bind: {
                events: function() {
                  s.is.page() &&
                    t.get(0).addEventListener('touchmove', s.event.preventScroll, { passive: !1 }),
                    'hover' == r.on
              ...
              unbind: {
                events: function() {
                  s.is.page() &&
                    t
                      .get(0)
                      .removeEventListener('touchmove', s.event.preventScroll, { passive: !1 }),
                    f.removeData(c),
                    t.off(o);
                },
              },
                ...
                openDownward: function(e) {
                  ...
                  return (
                    ...
                    (t = {
                      ...
                      ? (g.verbose('Dropdown can fit in context downward', t), (o = !0))
                      : t.below || t.above
                        ? (g.verbose('Dropdown cannot fit below, opening upward', t), (o = !1))
                        : (g.verbose(
                            ...
                            P.isPlainObject(a) && a[n] !== F
                              ...
                              : g.data(n) !== F
                                ...
                                : h.data(n) !== F
                                  ...
                                  : a[n];
                        i !== F
                          ? (l.verbose('Optional variable Found', n, i), (o = o.replace(t, i)))
            ...
            create: {
              ...
              mockedXHR: function() {
                ...
                return (
                  ...
                  i
                    ? (P.isFunction(i)
                        ? (l.debug('Using specified synchronous callback', i), (t = i.call(b, r)))
                        : (l.debug('Using settings specified response', i), (t = i)),
